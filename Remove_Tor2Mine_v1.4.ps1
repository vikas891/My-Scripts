...
#Pulling Bad Tasks
$st =  Get-ScheduledTask | where {($_.Actions.Execute -like "cmd" -or $_.Actions.Execute -like "*\cmd.exe") -and ($_.Actions.Arguments -like "*mshta*" -or $_.Actions.Arguments -like "*http*" -or $_.Actions.Arguments -like "*powershell*" -or $_.Actions.Arguments -like "*/c sc start cli_optimization_*")} 
$schtasks = @() 
